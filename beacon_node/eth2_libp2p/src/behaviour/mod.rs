...
impl<TSpec: EthSpec> Behaviour<TSpec> {
    pub async fn new(
        ...
        let params = PeerScoreParams {
            topics: HashMap::new(),
            topic_score_cap: 35.18,
            app_specific_weight: 1.0,
            ip_colocation_factor_weight: -35.18,
    ...
    pub fn subscribe_kind(&mut self, kind: GossipKind) -> bool {
        ...
        self.gossipsub.set_topic_params(gossip_topic.clone().into(), match kind {
            GossipKind::BeaconBlock => TopicScoreParams {
                ...
                mesh_message_deliveries_weight: -0.718,
                mesh_message_deliveries_decay: 0.9928,
                mesh_message_deliveries_cap: 14.0,
                mesh_message_deliveries_threshold: 139.0,
                mesh_message_deliveries_window: Duration::from_secs(4 * 32 * 12),
                mesh_message_deliveries_activation: Duration::from_millis(200),
            ...
            GossipKind::BeaconAggregateAndProof => TopicScoreParams {
                ...
                time_in_mesh_quantum: Duration::from_secs(12),
                time_in_mesh_cap: 300.0,
                first_message_deliveries_weight: 0.0243,
                first_message_deliveries_decay: 0.631,
                first_message_deliveries_cap: 65.0,
                mesh_message_deliveries_weight: -0.977,
                mesh_message_deliveries_decay: 0.631,
                mesh_message_deliveries_cap: 12.0,
                mesh_message_deliveries_threshold: 390.0,
                mesh_message_deliveries_window: Duration::from_secs(4 * 12),
                mesh_message_deliveries_activation: Duration::from_millis(200),
            ...
            GossipKind::Attestation(_) => TopicScoreParams {
                ...
                time_in_mesh_quantum: Duration::from_secs(12),
                time_in_mesh_cap: 300.0,
                first_message_deliveries_weight: 2.557,
                first_message_deliveries_decay: 0.866,
                first_message_deliveries_cap: 9.0,
                mesh_message_deliveries_weight: -11.26,
                mesh_message_deliveries_decay: 0.9532,
                mesh_message_deliveries_cap: 20.0,
                mesh_message_deliveries_threshold: 417.0,
                mesh_message_deliveries_window: Duration::from_secs(17 * 12),
                mesh_message_deliveries_activation: Duration::from_millis(200),
            ...
            GossipKind::VoluntaryExit => TopicScoreParams {
                ...
                invalid_message_deliveries_weight: -1407.315,
                invalid_message_deliveries_decay: 0.9971,
            },
